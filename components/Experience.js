    ...
    <section className="mb-4.5 grid break-inside-avoid grid-flow-row gap-2">
      <header className="grid grid-flow-col items-center justify-start gap-2">
        <div className="h-10 w-10">
          {logo && <Image src={logo} alt={company} width="400" height="400" />}
        </div>
        <div className="gap grid grid-flow-row">
          <h3 className="text-lg font-semibold leading-snugish text-stone-800">
            {company}
          </h3>
          ...
          return (
            <div className="pb-2">
              <div className="inline-flex items-baseline gap-2">
                <p className="text-md leading-normal text-stone-700">
                  {role.title}
                </p>
